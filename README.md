...
📦 data_driven-dashboard_vendas-principal
 ┣ 📊 dashboard_vendas.pbix       # Main Power BI report
 ┣ 📂 data/                       # Source data files (Excel / CSV)
 ┣ 🎨 assets/                     # Background images and theme files
 ┣ 📄 docs/                       # Supporting documentation (TXT / PDF)
 ┗ 📋 README.md
```

> ⚠️ *Update the filenames above to match your actual files before pushing.*
...
3. If needed, update the data source paths:
...
- ✅ DAX from fundamentals to advanced
...
```
📦 data_driven-dashboard_vendas-principal
 ┣ 📊 dashboard_vendas.pbix       # Relatório principal do Power BI
 ┣ 📂 data/                       # Arquivos de dados (Excel / CSV)
 ┣ 🎨 assets/                     # Imagens de fundo e arquivos de tema
 ┣ 📄 docs/                       # Documentação de apoio (TXT / PDF)
 ┗ 📋 README.md
```

> ⚠️ *Atualize os nomes dos arquivos acima com os nomes reais do seu projeto antes de fazer o push.*
...
3. Se necessário, atualize os caminhos das fontes de dados:
   - Vá em **Página Inicial → Transformar Dados → Configurações de Fonte de Dados**
4. Clique em **Atualizar** para recarregar todos os visuais
...
- ✅ Interface e navegação no Power BI
- ✅ Power Query e transformação de dados
- ✅ Modelagem de dados e relacionamentos
- ✅ DAX do básico ao avançado
- ✅ Design de dashboard e storytelling visual
